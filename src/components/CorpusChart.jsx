      ...
      <div className="flex justify-between items-start mb-4">
        ...
        {corpusZeroAge ? (
          <div className="bg-red-50 border border-red-200 rounded-lg px-3 py-2 text-center min-w-[110px]">
            <p className="text-[10px] font-semibold text-red-500 uppercase tracking-wide">Money Runs Out</p>
            <p className="text-2xl font-black text-red-600 tabular-nums">Age {corpusZeroAge}</p>
            <p className="text-[10px] text-red-400">{params.lifeExpectancy - corpusZeroAge} yrs short</p>
          </div>
        ) : (
          <div className="bg-green-50 border border-green-200 rounded-lg px-3 py-2 text-center min-w-[110px]">
            <p className="text-[10px] font-semibold text-green-500 uppercase tracking-wide">Portfolio Lasts</p>
            <p className="text-2xl font-black text-green-600">Age {params.lifeExpectancy}+</p>
            <p className="text-[10px] text-green-400">Fully funded ✔</p>
          </div>
        )}
      </div>
      ...
      <ResponsiveContainer width="100%" height={380}>
        <ComposedChart data={chartData} margin={{ top: 10, right: 20, left: 10, bottom: 20 }}>
          ...
          <ReferenceLine
            ...
            stroke="#CBD5E1"
            strokeDasharray="3 3"
            label={{ value: `Target: ${horizonLine}`, position: 'insideTopRight', fontSize: 9, fill: '#94A3B8' }}
          />
